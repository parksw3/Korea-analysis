...
Soon after the first church-related case was confirmed in Daegu on Feb 18, 2020, the daily traffic volume decreased by about 80\% and 50\% in Daegu and Seoul, respectively. \jd{Cut a lot of words here; I think it's fine, but see wyt.}
...
We are assuming that during the early period of an epidemic if we follow a consistent protocol of identifying and deciding whom to test, the positivity should stay about the same and that's the justification for the first correction.

\jd{Flow needs to be cleaned up here, but I'm not letting myself take the time.}
...
\jd{What do you mean by detection rate?}
...
\jd{It seems like it would be better to use the 
