...
We note that changes in the mean decrease delay (\fref{dist}C) reflect changes in incidence of symptomatic cases, whereas the decrease in the mean forward delay (\fref{dist}D) reflects the increase in the intensity of testing.
