...
While its success in suppressing the epidemic has been widely attributed to its intensive testing \citep{fergusonimpact, science}, other factors, such as social distancing, are also likely to have played important roles.
...
The number of negative cases was not reported on January 25 and 31, 2020; we took the average of cumulative negative cases one day before and after these days instead to impute missing values.
...
while social distancing is likely to have assisted in mitigating the spread in Seoul, our analysis suggests that 50\% decrease in metro traffic was insufficient to suppress the spread.
...
Its experience provides evidence that the epidemic can be suppressed without draconian measures as in China \citep{kickbusch2020response}.
...
However, our analysis does not allow us to measure the direct ``effect'' of social distancing on epidemiological dynamics.
...
Finally, our studies highlights the importance of characterizing geographical heterogeneity in estimating epidemic potential.
