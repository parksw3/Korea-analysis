...
casenum <- covid_line$case_id[!is.na(covid_line$case_id)]
...
ggsave("EID-20-1099-AppendixFigure1A.jpg", g1+theme(plot.title=element_blank()), width=4, height=4, dpi=600)
ggsave("EID-20-1099-AppendixFigure1B.jpg", g2+theme(plot.title=element_blank()), width=4, height=4, dpi=600)
ggsave("EID-20-1099-AppendixFigure1C.jpg", g3+theme(plot.title=element_blank()), width=4, height=4, dpi=600)
ggsave("EID-20-1099-AppendixFigure1D.jpg", g4+theme(plot.title=element_blank()), width=4, height=4, dpi=600)
